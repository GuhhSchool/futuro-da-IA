...
const contents = [
        ...
        alternatives: [
            {
                ...
                response: 'Desde o começo, se interessou pela parceria com a IA.',
            },
            {
                content: 'Tenho certeza que é golpe.',
                response: 'No começo, achou que era golpe e ficou com medo de conversar com a IA.',
            },
        ],
    },
    {
        ...
        alternatives: [
            {
                content: 'Converso com essa pessoa misteriosa, para que me ajude a encontrar informações relevantes para a lição e explique de forma que facilite o meu entendimento.',
            ...
            {
                content: 'Resolvo a lição com base nas conversas que tive com colegas, algumas pesquisas na internet e conhecimentos próprios sobre o tema.',
                response: 'Um tempo depois, optou por não usar as novidades dela pois pensava que se sairia bem na atividades escolares que tinha, usando as próprias fontes de conhecimento.',
                subcategory: 1,
            },
        ],
    },
    {
        ...
        alternatives: [
            ...
            {
                content: 'Me preocupo com as pessoas que perderão seus méritos por conta de pessoas como a que ajudou seu colega, e defendo a importância de valorizar quem trabalha duro.',
                response: 'Por conta dessa decisão, G{nome} não conseguiu a melhor nota da turma apesar do grande esforço, tirando a conclusão de que inteligências artificiais apenas prejudicaria pessoas que se esforçam e trabalham duro.',
            },
        ],
    },
    {
        order: 2,
        history: "No dia seguinte, ao entregar as lições, seu amigo estudioso errou apenas uma questão. Se aproximando de você, a professora diz que você acertou todas! Então, ela decide fazer perguntas sobre as lições das quais você consegue responder facilmente mesmo você tendo aprendido apenas no dia anterior. O que você pensa?",
        subcategory: 2,
        alternatives: [
            {
                content: 'Defendo a ideia de que a ajuda dessa pessoa misteriosa pode criar novas oportunidades e até melhorar habilidades humanas',
        ...
        alternatives: [
            {
                ...
                response: 'Um tempo passou e, quando G{nome} descobriu do que a IA realmente é capaz, se surpreendeu tanto que resolveu começar a usá-la frequentemente até os dias atuais, ajudando diariamente em tarefas cotidianas.',
            },
            {
...
let currentIndex = 0;
let name = '';
let currentHistory = 'G{nome}, Em 2049... <br>';
...
class showHistory {
    ...
    #showResult() {
        textHistoryElement.innerHTML = currentHistory;
        beforeHeight();
        buttonBoxElement.textContent = "";
    }
}
